...
namespace comonResourceManagement {
	...
	/// <summary>
	/// popUp_user에 대한 요약입니다.
	/// </summary>
	public ref class popUp_user : public System::Windows::Forms::Form
	{
	public:
		popUp_user(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(popUp_user::typeid));
			...
			// cancel
			// 
			this->cancel->Location = System::Drawing::Point(38, 106);
			this->cancel->Name = L"cancel";
			this->cancel->Size = System::Drawing::Size(86, 31);
			this->cancel->TabIndex = 7;
			this->cancel->Text = L"취소";
			this->cancel->UseVisualStyleBackColor = true;
			this->cancel->Click += gcnew System::EventHandler(this, &popUp_user::cancel_Click);
			// 
			// submit_button
			// 
			this->submit_button->Location = System::Drawing::Point(156, 106);
			...
			this->submit_button->Click += gcnew System::EventHandler(this, &popUp_user::submit_button_Click);
			// 
			// items
			// 
			this->items->Location = System::Drawing::Point(38, 69);
			...
			this->label1->Text = L"추가할 직원 이름을 입력해주세요.";
			// 
			// popUp_user
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(7, 12);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(284, 169);
			this->Controls->Add(this->cancel);
			this->Controls->Add(this->submit_button);
			this->Controls->Add(this->items);
			this->Controls->Add(this->label1);
			this->Icon = (cli::safe_cast<System::Drawing::Icon^>(resources->GetObject(L"$this.Icon")));
			this->Name = L"popUp_user";
...
#pragma endregion
	...
	private: System::Void submit_button_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (item.size() == 0) {
			...
			string query = "INSERT INTO `comon`.`user_list` (`user_items`) VALUES ('" + item + "');";
