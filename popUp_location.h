...
namespace comonResourceManagement {
	...
	/// <summary>
	/// popUp_location에 대한 요약입니다.
	/// </summary>
	public ref class popUp_location : public System::Windows::Forms::Form
	{
	public:
		popUp_location(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(popUp_location::typeid));
			...
			this->cancel->Click += gcnew System::EventHandler(this, &popUp_location::cancel_Click);
			// 
			// submit_button
			// 
			...
			this->submit_button->Click += gcnew System::EventHandler(this, &popUp_location::submit_button_Click);
			// 
			// items
			// 
			...
			this->label1->Text = L"추가할 위치 항목을 입력해주세요.";
			// 
			// popUp_location
			// 
...
#pragma endregion
	private: System::Void submit_button_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (item.size() == 0) {
			...
			string query = "INSERT INTO `comon`.`location_list` (`location_items`) VALUES ('" + item + "');";
