...
namespace comonResourceManagement {
	...
	/// <summary>
	/// popUp_modify_user에 대한 요약입니다.
	/// </summary>
	public ref class popUp_modify_user : public System::Windows::Forms::Form
	{
	public:
		const char* ulid;
		popUp_modify_user(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(popUp_modify_user::typeid));
			...
			this->comboBox1->Location = System::Drawing::Point(141, 86);
			...
			this->label3->Location = System::Drawing::Point(37, 120);
			...
			// etc_data
			// 
			this->etc_data->Location = System::Drawing::Point(141, 120);
			...
			this->label2->Text = L"직원 이름";
			// 
			// cancel
			// 
			this->cancel->Location = System::Drawing::Point(84, 165);
			...
			// submit_button
			// 
			this->submit_button->Location = System::Drawing::Point(249, 165);
			...
			this->submit_button->Click += gcnew System::EventHandler(this, &popUp_modify_user::submit_button_Click_1);
			// 
			// label1
			// 
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"맑은 고딕", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(129)));
			this->label1->Location = System::Drawing::Point(79, 36);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(318, 28);
			this->label1->TabIndex = 23;
			this->label1->Text = L"수정할 직원 정보를 선택해주세요.";
			// 
			// popUp_modify_user
			// 
			...
			this->ClientSize = System::Drawing::Size(445, 240);
			...
			this->Name = L"popUp_modify_user";
			this->Text = L"ITMan-PC";
			this->Load += gcnew System::EventHandler(this, &popUp_modify_user::MyForm_Load);
	...
	private: System::Void cancel_Click(System::Object^ sender, System::EventArgs^ e) {
		Close();
		   ...
		   private: System::Void MyForm_Load(System::Object^ sender, System::EventArgs^ e) {
			   ...
			   list<string> result = rm.getUserList();
...
private: System::Void submit_button_Click_1(System::Object^ sender, System::EventArgs^ e) {
	...
	if (data.size() <= 0) {
		...
		string query = "UPDATE `comon`.`resource_details` SET `user` = '" + data + "' WHERE (`ulid` = '" + string(ulid) + "');";
		int result = rm.updateResource(query);

		string contents = rd.user + "->" + data;

		rm.createHistory("수정", "직원 이름", contents, etc);
