...
namespace comonResourceManagement {
	...
	/// <summary>
	/// popUp_modify_locate에 대한 요약입니다.
	/// </summary>
	public ref class popUp_modify_locate : public System::Windows::Forms::Form
	{
	public:
		const char* ulid;
		popUp_modify_locate(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(popUp_modify_locate::typeid));
			...
			this->comboBox1->Location = System::Drawing::Point(146, 87);
			...
			this->label3->Location = System::Drawing::Point(42, 121);
			...
			// etc_data
			// 
			this->etc_data->Location = System::Drawing::Point(146, 121);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"맑은 고딕", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(129)));
			this->label2->Location = System::Drawing::Point(42, 87);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(52, 28);
			this->label2->TabIndex = 26;
			this->label2->Text = L"위치";
			// 
			// cancel
			// 
			this->cancel->Location = System::Drawing::Point(89, 166);
			...
			this->cancel->Click += gcnew System::EventHandler(this, &popUp_modify_locate::cancel_Click);
			// 
			// submit_button
			// 
			this->submit_button->Location = System::Drawing::Point(254, 166);
			...
			this->submit_button->Click += gcnew System::EventHandler(this, &popUp_modify_locate::submit_button_Click);
			// 
			// label1
			// 
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"맑은 고딕", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(129)));
			this->label1->Location = System::Drawing::Point(103, 36);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(271, 28);
			this->label1->TabIndex = 23;
			this->label1->Text = L"수정할 위치를 선택해주세요.";
			// 
			// popUp_modify_locate
			// 
			...
			this->Name = L"popUp_modify_locate";
			this->Text = L"ITMan-PC";
			this->ResumeLayout(false);
			this->PerformLayout();
			this->Load += gcnew System::EventHandler(this, &popUp_modify_locate::MyForm_Load);
		}
#pragma endregion
	private: System::Void cancel_Click(System::Object^ sender, System::EventArgs^ e) {
		Close();
		   ...
		   private: System::Void MyForm_Load(System::Object^ sender, System::EventArgs^ e) {
			   ...
			   list<string> result = rm.getLocationList();
...
private: System::Void submit_button_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (data.size() <= 0) {
		...
		string query = "UPDATE `comon`.`resource_details` SET `location` = '" + data + "' WHERE (`ulid` = '" + string(ulid) + "');";
		int result = rm.updateResource(query);

		string contents = rd.location + "->" + data;

		rm.createHistory("수정", "위치", contents, etc);
